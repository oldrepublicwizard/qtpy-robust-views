...
from qtpy_robust_views.itemviews.abstractview import RobustAbstractItemView
...
class RobustListView(RobustAbstractItemView, QListView):
    ...
    def build_context_menu(
        ...
        self._add_menu_action(
            settings_menu, "Spacing", self.spacing, self.setSpacing, "spacing", param_type=int
        )
        self._add_menu_action(
            settings_menu,
            "Batch Size",
        ...
        self._add_exclusive_menu_action(
            ...
            self.resizeMode,
            self.setResizeMode,
            options={"Fixed": QListView.ResizeMode.Fixed, "Adjust": QListView.ResizeMode.Adjust},
        ...
        self._add_menu_action(
            settings_menu, "Wrapping", self.isWrapping, self.setWrapping, "wrapping"
        )
        ...
        self._add_simple_action(
            actions_menu,
            "Scroll to Top",
            lambda: self.scrollTo(self.model().index(0, 0), QListView.ScrollHint.PositionAtTop),
